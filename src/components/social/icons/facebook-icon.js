...
export default props => {
    ...
    return (
        <svg id="facebook-icon" className={ props.className } viewBox={`0 0 ${props.width} ${props.height}`} width={props.width} height={props.height}  aria-labelledby="title" xmlns="http://www.w3.org/2000/svg">
