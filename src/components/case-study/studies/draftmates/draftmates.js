    ...
    <React.Fragment>
        ...
        <AngledSection className='big-picture-wrapper' mask='angle--both-left-right'>
            <Cta heading='Big Picture' className='big-picture'>
                ...
                <LinkOutlined className='big-picture-button' linkTo='#'>Download Draftmates</LinkOutlined>
            </Cta>
        </AngledSection>
        ...
        <Section className='why-appstem angle--top-left' style={{ background: '#fafafa', width: '100vw', marginTop: '-7.3%' }}>
